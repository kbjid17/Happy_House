...
public class UserDto {
	...
	public UserDto(int userSeq, String userName, String userPassword, String userEmail, String userPhone,
			String userAddress, String userProfileImageUrl, Date userRegisterDate, String userClsf) {
